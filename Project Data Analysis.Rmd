---
title: "Projet LSTAT2110 - Analyse des donnÃƒÂ©es"
...
La sphère des corrélations quant à elle nous indique la même chose que la matrice des corrélation étudiée dans la section sur l'analyse descriptive. 

# Clustering 
Passons maintenant au clustering de notre jeu de données. 
Pour cette partie, comme les individus sont normalement distribués, nous utiliserons la classification hiérarchique.  
Voici les résultats :  
